...
function Product() {
  ...
  return (
    <div className="flex bg-[#f1f1f1] w-full min-h-[92vh]">
        ...
        <div className="flex flex-col max-w-[70%] ml-[110px] pt-[30px] px-[20px] ">
          ...
          <div className="flex w-[100%] flex-col">
            ...
            <div className="flex my-[2px]">
              ...
              <span className="">
                Features a Sleek UI with Tailwind CSS and Redux state
                management.
              </span>
            </div>
            <div className="flex my-[2px]">
            ...
            <div className="flex my-[2px]">
              ...
              <span className=""></span>Node.js backend, authentication, and
              CRUD dashboard.
            </div>
          </div>
        </div>
      ...
      {/* MOBILE VIEW */}
      <div className="md:hidden w-full min-h-[92vh] relative flex flex-col  ">
